...
class CSSTrackActor(BaseActor):
    ...
    def compute_losses(self, pred_dict, gt_dict, return_status=True):
        ...
        cg0 = pred_dict['cg_res'][0] * 1.0 / pred_dict['cg_res'][0].max()
        cg1 = pred_dict['cg_res'][1] * 1.0 / pred_dict['cg_res'][1].max()
        cg2 = pred_dict['cg_res'][2] * 1.0 / pred_dict['cg_res'][2].max()
        cg3 = pred_dict['cg_res'][3] * 1.0 / pred_dict['cg_res'][3].max()
