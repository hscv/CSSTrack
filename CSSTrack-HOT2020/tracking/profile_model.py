...
def parse_args():
    ...
    # for train
    parser.add_argument('--script', type=str, default='csstrack', choices=['csstrack'],
                        help='training script name')
    parser.add_argument('--config', type=str, default='multi-hivit-ep30-4frames', help='yaml configure file name')
...
if __name__ == "__main__":
    ...
    if args.script == "csstrack":
        model_module = importlib.import_module('lib.models')
        model_constructor = model_module.build_csstrack
