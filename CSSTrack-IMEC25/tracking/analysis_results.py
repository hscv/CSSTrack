...
trackers = []
dataset_name = 'hot20'#analysis lasot
"""stark"""
...
'''CSSTrack'''
trackers.extend(trackerlist(name='csstrack', parameter_name='CSSTrack_ep30_full_256', dataset_name=dataset_name,
                            save_name='csstrack_hivitb_v1-30', run_ids=None, display_name='CSSTrack256_30')) 
