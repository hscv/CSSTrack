...
def run_tracker(tracker_name, tracker_param, save_name, run_id=None, dataset_name='otb', sequence=None, debug=0,
                threads=0, num_gpus=8, checkpoint_path=''):
...
def main(num, dataset, cfg, savename):
    ...
    parser.add_argument('--tracker_name', type=str, default='csstrack', help='Name of tracking method.')
    parser.add_argument('--tracker_param', type=str, default=cfg, help='Name of config file.')
    parser.add_argument('--save_name', type=str, default='csstrack_hivitb_v1-'+str(num), help='Name of save file.')
...
def set_state(state, tracker_param):
    path = './experiments/csstrack/'+tracker_param+'.yaml'
...
if __name__ == '__main__':
    cfg = 'CSSTrack-ep30-s256'
    datasets = ['imec25']
    epoch = 30 # test the 30th epoch
    savename = 'hivitb_224_ep'+str(epoch)
    for dataset in datasets:
        main(epoch,dataset,cfg, savename) #test the 30th epoch
