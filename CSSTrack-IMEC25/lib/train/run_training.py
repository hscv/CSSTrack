...
def main():
    ...
    parser.add_argument('--script', type=str, default='csstrack', help='Name of the train script.')
    parser.add_argument('--config', type=str, default='CSSTrack-ep30-s256', help="Name of the config file.")
