...
class CSSTrack(BaseTracker):
    def __init__(self, params, dataset_name):
        super(CSSTrack, self).__init__(params)
        network = build_csstrack(params.cfg, training=False)
    ...
    def track(self, image, info: dict = None):
        ...
        self.state = clip_box(self.map_box_back(pred_box, resize_factor), H, W, margin=3)
